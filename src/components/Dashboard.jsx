            ...
            <div className="container-fluid">
              <div className="row border-bottom mb-4 pb-4">
                ...
                <div className="col-sm-5">
                  <label className="font-weight-normal" for="reportType">
                    Loại chương trình{" "}
                  </label>
                  <select class="custom-select option-select">
                    ...
                    <option className="opchildren" value="1">
                      Tất cả
                    </option>
                    <option className="opchildren" value="2">
                      Chương trình trọng điểm cấp nhà nước
                    </option>
                    <option className="opchildren" value="3">
                      Chương trình độc lập quỹ gen
                    </option>
                  </select>
                </div>
                        ...
                        <tbody>
                          {programs?.map((item, key) => (
                            <tr key={key}>
                              ...
                              <td className="project-actions text-right">
                              <a className="btn btn-info btn-sm mb-1" href={`/search/chuyengia/${item.id}`}>
                                                                
                                                                <i className="fas fa-pencil-alt" /> Chuyên gia
                                                                </a>
                                                                <a className="btn btn-success btn-sm" href={`/search/nhiemvu/${item.id}`}>
