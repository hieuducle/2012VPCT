...
import {getChucvuAPI} from "../../../src/api/todos";
...
export default class Degree_con extends Component {
    ...
    fetchData = async () => {
        const chucvus = await getChucvuAPI();
        this.setState({ chucvus });
    };
    render() {
        const { chucvus } = this.state;
        return (
            <div>
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            ...
                            <ol className="breadcrumb float-sm-right">
                                <li className="breadcrumb-item"><a href="/category/position">Chức vụ</a></li>
